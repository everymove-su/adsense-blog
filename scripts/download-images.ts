...
const posts: { slug: string; keyword: string }[] = [
  ...
  { slug: 'kalguksu-recipe', keyword: 'korean knife cut noodle soup' },
  { slug: 'gamja-jorim-recipe', keyword: 'korean braised potatoes soy sauce' },
  { slug: 'tangsuyuk-recipe', keyword: 'korean chinese sweet sour pork' },
  { slug: 'jokbal-recipe', keyword: 'korean braised pigs feet jokbal' },
  { slug: 'sujebi-recipe', keyword: 'korean hand torn noodle soup' },
  { slug: 'sigeumchi-namul-recipe', keyword: 'korean spinach side dish namul' },
  { slug: 'ueong-jorim-recipe', keyword: 'korean braised burdock root' },
  { slug: 'kkanpungi-recipe', keyword: 'korean chinese crispy spicy chicken' },
